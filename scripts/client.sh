...
./nvm_client -addr="db1.cs.purdue.edu:8964" --force_use_numa_node=false --use_numa_node=0 --numa_type=1 --threads=28 --coros=1 --id=0 --use_nic_idx=0 --remote_nic_idx=0 --payload=64 --use_read=false --add_sync=false --address_space=8 --random=true -read_write=false --doorbell=true --batch=1 -two_qp=false
